...
<?php 
    ...
    if(isset($_GET['edit_manufacturer'])){
        ...
        $m_name = $row_edit_manufacturer['manufacturer_title'];
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    <div class="form-group"><!-- form-group 1 begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input name="manufacturer_name" type="text" class="form-control"  value="<?php echo $m_name; ?> ">
                    ...
                    <div class="form-group"><!-- form-group 3 begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <img width="70" height="70"  src="other_images/<?php echo $m_image; ?>" alt="<?php echo $m_image; ?>" class="img-responsive">
